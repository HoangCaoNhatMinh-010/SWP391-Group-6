...
VALUES
  ('VinFast', 'VF 5 Plus', 'Car', 499000, N'Màn hình cảm ứng 10 inch;Hệ thống hỗ trợ lái ADAS;Sạc nhanh;Kết nối thông minh'),
  ('VinFast', 'VF 6', 'Car', 599000, N'Màn hình cảm ứng 12.9 inch;ADAS nâng cao;Sạc nhanh;Ghế da cao cấp;Cửa sổ trời Panorama'),
  ('VinFast', 'VF 7', 'Car', 699000, N'Màn hình cảm ứng 12.9 inch;ADAS cấp 2;Sạc nhanh DC;Ghế chỉnh điện;Âm thanh 8 loa'),
  ('VinFast', 'VF 8', 'Car', 899000, N'Màn hình cảm ứng 15.6 inch;ADAS cấp 2+;Sạc nhanh DC 150kW;Ghế massage;Âm thanh 11 loa;Cốp điện'),
  ('VinFast', 'VF 9', 'Car', 1099000, N'Màn hình cảm ứng 15.6 inch;ADAS cấp 2+;Sạc nhanh DC 150kW;7 chỗ ngồi;Ghế massage;Âm thanh 13 loa;Cửa sổ trời Panorama;Hệ thống treo khí nén'),
  ('VinFast', 'VF e34', 'Car', 450000, N'Màn hình cảm ứng 10 inch;Hệ thống an toàn cơ bản;Sạc AC;Kết nối Bluetooth');
...
VALUES
  ...
  (10, 6, 1, 2, '2025-01-10 10:00:00', '2025-01-13 18:00:00', 3900000, 'CANCALLED'),
